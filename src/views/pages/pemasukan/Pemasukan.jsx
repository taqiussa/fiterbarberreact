...
const Pemasukan = () => {
    ...
    const fetchData = async () => {
        ...
        await axios
            ...
            .then(res => {
                const fendis = res.data.fendi;
                const bayus = res.data.bayu;
                const budis = res.data.budi;
                setIsLoading(false);
                setFendi({
                    columns: [
                        // {
                    ...
                    rows: fendis.map((pemasukan, index) => {
                        return (
                            {
                                // id: index + 1,
                                // tanggal: Moment(pemasukan.tanggal).format("dddd, DD MMM YYYY"),
                                tanggal: Moment(pemasukan.tanggal).format("DD-MM"),
                ...
                setBayu({
                    ...
                    rows: bayus.map((pemasukan, index) => {
                        return (
                            {
                                // id: index + 1,
                                // tanggal: Moment(pemasukan.tanggal).format("dddd, DD MMM YYYY"),
                ...
                setBudi({
                    ...
                    rows: budis.map((pemasukan, index) => {
                        return (
                            {
                                // id: index + 1,
                                // tanggal: Moment(pemasukan.tanggal).format("dddd, DD MMM YYYY"),
                    ...
                    <Row className="mb-4">
                        <Col md="12">
                            <Card>
                                ...
                                <Row>
                                    <Col md="4">
                                    <Card.Title as="h4" className="ml-4">Fendi</Card.Title>
                                        <Card.Body>
                                            {/* <MDBDataTable small striped bordered hover data={data} paginationLabel={['Prev', 'Next']}
                                        info={false} responsive /> */}
                                            <MDBDataTableV5 data={fendi} hover responsive searching={false} />
                                        </Card.Body>
                                    </Col>
                                    <Col md="4">
                                    <Card.Title as="h4" className="ml-4">Bayu</Card.Title>
                                        <Card.Body>
                                            <MDBDataTableV5 data={bayu} hover responsive searching={false} />
                                        </Card.Body>
                                    </Col>
                                    <Col md="4">
                                        <Card.Title as="h4" className="ml-4">Budi</Card.Title>
                                        <Card.Body>
                                            <MDBDataTableV5 data={budi} hover responsive searching={false} />
                                        </Card.Body>
                                    </Col>
                                </Row>
                            </Card>
